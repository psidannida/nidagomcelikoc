...
# --- 2. MÜFREDAT LİSTESİ ---
m_yks = {
    "TYT Matematik": ["Temel Kavramlar", "Sayı Basamakları", "Bölme-Bölünebilme", "Problemler", "Fonksiyonlar"],
    "TYT Türkçe": ["Paragraf", "Dil Bilgisi", "Yazım-Noktalama"],
    "TYT Felsefe/Sosyal": ["Tarih", "Coğrafya", "Felsefe", "Din Kültürü"],
...
if "logged_in" not in st.session_state:
    ...
    if st.session_state["role"] == "admin":
        ...
        menu = st.sidebar.radio("Menü", ["Öğrenci Kaydı", "Rapor & WhatsApp", "Grafik Analiz"])
        ...
        if menu == "Öğrenci Kaydı":
            ...
            st.markdown(f'<a href="{url}" target="_blank" style="background-color:#25D366; color:white; padding:10px; text-decoration:none; border-radius:5px; font-weight:bold;">📱 Veliye WhatsApp Gönder</a>', unsafe_allow_html=True)
            st.table(bugun_df)
    ...
    # --- 6. ÖĞRENCİ PANELİ ---
        ...
        tab1, tab2 = st.tabs(["📝 Veri Girişi", "📊 Grafiklerim"])
        with tab1:
